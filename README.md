...
### Diretta is proprietary software by Yu Harada. The Diretta UPnP Renderer is an open‑source Host implementation built using the Diretta Host SDK, which is also owned by Yu Harada.
